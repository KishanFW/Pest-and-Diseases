...
class ApiController extends Controller
{
    ...
    public function pestsofsymptoms(){
        ...
        foreach ($symptoms as $symptom){
            $array = DB::select("select pest_name, management, img_path from pests where pest_name in
    ...
    public function diseasesofsymptoms(){
        ...
        foreach ($symptoms as $symptom){
            $array = DB::select("select disease_name, causal_organism, management, img_path from diseases where disease_name in
